...
const ForgotPasswordScreen = props => {
    ...
    <View style={{flexDirection: 'row', alignContent: 'space-between', marginTop: 60}}>
    ...
    <Text style={{fontSize: 16 , color: '#427f95', margin: 20 }}>Fill your emp-id and hit ENTER</Text>
...
<TextInput  
      ...
      <TouchableOpacity style={styles.appButtonContainer1}>
        <Text style={styles.appButtonText}>Change</Text>
        </TouchableOpacity>
